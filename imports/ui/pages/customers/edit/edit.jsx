...
export class CustomersEditPage extends Component {
	...
	<div>
		<div className="page-container container" id="content">
			...
			<CustomersEditPageForm data={this.props.data} routeParams={this.props.routeParams} />
		</div>
	</div>
);
		}
...
export class CustomersEditPageForm extends Component {
	constructor () {
		super();

		this.state = {
			customersEditPageFormErrorMessage: "",
			customersEditPageFormInfoMessage: ""
		};
	...
	<div className="alert alert-warning">
		{this.state.customersEditPageFormErrorMessage}
	</div>
);
	}
	...
	<div className="alert alert-success">
		{this.state.customersEditPageFormInfoMessage}
	</div>
);
	}
	...
	onSubmit(e) {
		e.preventDefault();
		this.setState({ customersEditPageFormInfoMessage: "" });
		this.setState({ customersEditPageFormErrorMessage: "" });

		var self = this;
		var $form = $(e.target);

		function submitAction(result, msg) {
			var customersEditPageFormMode = "update";
			if(!$("#customers-edit-page-form").find("#form-cancel-button").length) {
				switch(customersEditPageFormMode) {
					case "insert": {
						$form[0].reset();
					}; break;
					...
					case "update": {
						...
						self.setState({ customersEditPageFormInfoMessage: message });
					}; break;
				}
			}
		...
		function errorAction(msg) {
			...
			self.setState({ customersEditPageFormErrorMessage: message });
		}
	...
	render() {
		return (
	<div id="customers-edit-page-form" className="">
		...
		<form role="form" onSubmit={this.onSubmit}>
			{this.state.customersEditPageFormErrorMessage ? this.renderErrorMessage() : null}
					{this.state.customersEditPageFormInfoMessage ? this.renderInfoMessage() : null}
