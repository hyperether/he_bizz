...
export class InvoicesEditPage extends Component {
	...
	<div>
		<div className="page-container container" id="content">
			...
			<InvoicesEditPageForm data={this.props.data} routeParams={this.props.routeParams} />
		</div>
	</div>
);
		}
...
export class InvoicesEditPageForm extends Component {
	constructor () {
		super();

		this.state = {
			invoicesEditPageFormErrorMessage: "",
			invoicesEditPageFormInfoMessage: ""
		};
	...
	<div className="alert alert-warning">
		{this.state.invoicesEditPageFormErrorMessage}
	</div>
);
	}
	...
	<div className="alert alert-success">
		{this.state.invoicesEditPageFormInfoMessage}
	</div>
);
	}
	...
	onSubmit(e) {
		e.preventDefault();
		this.setState({ invoicesEditPageFormInfoMessage: "" });
		this.setState({ invoicesEditPageFormErrorMessage: "" });

		var self = this;
		var $form = $(e.target);

		function submitAction(result, msg) {
			var invoicesEditPageFormMode = "update";
			if(!$("#invoices-edit-page-form").find("#form-cancel-button").length) {
				switch(invoicesEditPageFormMode) {
					case "insert": {
						$form[0].reset();
					}; break;
					...
					case "update": {
						...
						self.setState({ invoicesEditPageFormInfoMessage: message });
					}; break;
				}
			}
		...
		function errorAction(msg) {
			...
			self.setState({ invoicesEditPageFormErrorMessage: message });
		}
	...
	render() {
		return (
	<div id="invoices-edit-page-form" className="">
		...
		<form role="form" onSubmit={this.onSubmit}>
			{this.state.invoicesEditPageFormErrorMessage ? this.renderErrorMessage() : null}
					{this.state.invoicesEditPageFormInfoMessage ? this.renderInfoMessage() : null}
