...
export class InvoicesInsertPage extends Component {
	...
	<div>
		<div className="page-container container" id="content">
			...
			<InvoicesInsertPageForm data={this.props.data} routeParams={this.props.routeParams} />
		</div>
	</div>
);
		}
...
export class InvoicesInsertPageForm extends Component {
	constructor () {
		super();

		this.state = {
			invoicesInsertPageFormErrorMessage: "",
			invoicesInsertPageFormInfoMessage: ""
		};
	...
	<div className="alert alert-warning">
		{this.state.invoicesInsertPageFormErrorMessage}
	</div>
);
	}
	...
	<div className="alert alert-success">
		{this.state.invoicesInsertPageFormInfoMessage}
	</div>
);
	}
	...
	onSubmit(e) {
		e.preventDefault();
		this.setState({ invoicesInsertPageFormInfoMessage: "" });
		this.setState({ invoicesInsertPageFormErrorMessage: "" });

		var self = this;
		var $form = $(e.target);

		function submitAction(result, msg) {
			var invoicesInsertPageFormMode = "insert";
			if(!$("#invoices-insert-page-form").find("#form-cancel-button").length) {
				switch(invoicesInsertPageFormMode) {
					case "insert": {
						$form[0].reset();
					}; break;
					...
					case "update": {
						...
						self.setState({ invoicesInsertPageFormInfoMessage: message });
					}; break;
				}
			}
		...
		function errorAction(msg) {
			...
			self.setState({ invoicesInsertPageFormErrorMessage: message });
		}
	...
	render() {
		return (
	<div id="invoices-insert-page-form" className="">
		...
		<form role="form" onSubmit={this.onSubmit}>
			{this.state.invoicesInsertPageFormErrorMessage ? this.renderErrorMessage() : null}
					{this.state.invoicesInsertPageFormInfoMessage ? this.renderInfoMessage() : null}
