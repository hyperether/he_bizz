...
export class RolesEditPage extends Component {
	constructor () {
		super();
	...
	<div>
		<div className="page-container container" id="content">
			...
			<RolesEditPageForm data={this.props.data} routeParams={this.props.routeParams} />
		</div>
	</div>
);
		}
...
export const RolesEditPageContainer = withTracker(function(props) {
...
export class RolesEditPageForm extends Component {
	constructor () {
		super();

		this.state = {
			rolesEditPageFormErrorMessage: "",
			rolesEditPageFormInfoMessage: ""
		};
	...
	<div className="alert alert-warning">
		{this.state.rolesEditPageFormErrorMessage}
	</div>
);
	}
	...
	<div className="alert alert-success">
		{this.state.rolesEditPageFormInfoMessage}
	</div>
);
	}
	...
	onSubmit(e) {
		e.preventDefault();
		this.setState({ rolesEditPageFormInfoMessage: "" });
		this.setState({ rolesEditPageFormErrorMessage: "" });

		var self = this;
		var $form = $(e.target);

		function submitAction(result, msg) {
			var rolesEditPageFormMode = "update";
			if(!$("#roles-edit-page-form").find("#form-cancel-button").length) {
				switch(rolesEditPageFormMode) {
					case "insert": {
						$form[0].reset();
					}; break;
					...
					case "update": {
						...
						self.setState({ rolesEditPageFormInfoMessage: message });
					}; break;
				}
			}
		...
		function errorAction(msg) {
			...
			self.setState({ rolesEditPageFormErrorMessage: message });
		}
	...
	render() {
		return (
	<div id="roles-edit-page-form" className="">
		...
		<form role="form" onSubmit={this.onSubmit}>
			{this.state.rolesEditPageFormErrorMessage ? this.renderErrorMessage() : null}
					{this.state.rolesEditPageFormInfoMessage ? this.renderInfoMessage() : null}
