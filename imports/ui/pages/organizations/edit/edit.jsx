...
export class OrganizationsEditPage extends Component {
	constructor () {
		super();
	...
	<div>
		<div className="page-container container" id="content">
			...
			<OrganizationsEditPageForm data={this.props.data} routeParams={this.props.routeParams} />
		</div>
	</div>
);
		}
...
export const OrganizationsEditPageContainer = withTracker(function(props) {
...
export class OrganizationsEditPageForm extends Component {
	constructor () {
		super();

		this.state = {
			organizationsEditPageFormErrorMessage: "",
			organizationsEditPageFormInfoMessage: ""
		};
	...
	<div className="alert alert-warning">
		{this.state.organizationsEditPageFormErrorMessage}
	</div>
);
	}
	...
	<div className="alert alert-success">
		{this.state.organizationsEditPageFormInfoMessage}
	</div>
);
	}
	...
	onSubmit(e) {
		e.preventDefault();
		this.setState({ organizationsEditPageFormInfoMessage: "" });
		this.setState({ organizationsEditPageFormErrorMessage: "" });

		var self = this;
		var $form = $(e.target);

		function submitAction(result, msg) {
			var organizationsEditPageFormMode = "update";
			if(!$("#organizations-edit-page-form").find("#form-cancel-button").length) {
				switch(organizationsEditPageFormMode) {
					case "insert": {
						$form[0].reset();
					}; break;
					...
					case "update": {
						...
						self.setState({ organizationsEditPageFormInfoMessage: message });
					}; break;
				}
			}
		...
		function errorAction(msg) {
			...
			self.setState({ organizationsEditPageFormErrorMessage: message });
		}
	...
	render() {
		return (
	<div id="organizations-edit-page-form" className="">
		...
		<form role="form" onSubmit={this.onSubmit}>
			{this.state.organizationsEditPageFormErrorMessage ? this.renderErrorMessage() : null}
					{this.state.organizationsEditPageFormInfoMessage ? this.renderInfoMessage() : null}
