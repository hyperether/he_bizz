...
export class ProjectsEditPage extends Component {
	constructor () {
		super();
	...
	<div>
		<div className="page-container container" id="content">
			...
			<ProjectsEditPageForm data={this.props.data} routeParams={this.props.routeParams} />
		</div>
	</div>
);
		}
...
export const ProjectsEditPageContainer = withTracker(function(props) {
...
export class ProjectsEditPageForm extends Component {
	constructor () {
		super();

		this.state = {
			projectsEditPageFormErrorMessage: "",
			projectsEditPageFormInfoMessage: ""
		};
	...
	<div className="alert alert-warning">
		{this.state.projectsEditPageFormErrorMessage}
	</div>
);
	}
	...
	<div className="alert alert-success">
		{this.state.projectsEditPageFormInfoMessage}
	</div>
);
	}
	...
	onSubmit(e) {
		e.preventDefault();
		this.setState({ projectsEditPageFormInfoMessage: "" });
		this.setState({ projectsEditPageFormErrorMessage: "" });

		var self = this;
		var $form = $(e.target);

		function submitAction(result, msg) {
			var projectsEditPageFormMode = "update";
			if(!$("#projects-edit-page-form").find("#form-cancel-button").length) {
				switch(projectsEditPageFormMode) {
					case "insert": {
						$form[0].reset();
					}; break;
					...
					case "update": {
						...
						self.setState({ projectsEditPageFormInfoMessage: message });
					}; break;
				}
			}
		...
		function errorAction(msg) {
			...
			self.setState({ projectsEditPageFormErrorMessage: message });
		}
	...
	render() {
		return (
	<div id="projects-edit-page-form" className="">
		...
		<form role="form" onSubmit={this.onSubmit}>
			{this.state.projectsEditPageFormErrorMessage ? this.renderErrorMessage() : null}
					{this.state.projectsEditPageFormInfoMessage ? this.renderInfoMessage() : null}
