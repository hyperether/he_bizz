...
export class EmployeesEditPage extends Component {
	constructor () {
		super();
	...
	<div>
		<div className="page-container container" id="content">
			...
			<EmployeesEditPageForm data={this.props.data} routeParams={this.props.routeParams} />
		</div>
	</div>
);
		}
...
export const EmployeesEditPageContainer = withTracker(function(props) {
...
export class EmployeesEditPageForm extends Component {
	constructor () {
		super();

		this.state = {
			employeesEditPageFormErrorMessage: "",
			employeesEditPageFormInfoMessage: ""
		};
	...
	<div className="alert alert-warning">
		{this.state.employeesEditPageFormErrorMessage}
	</div>
);
	}
	...
	<div className="alert alert-success">
		{this.state.employeesEditPageFormInfoMessage}
	</div>
);
	}
	...
	onSubmit(e) {
		e.preventDefault();
		this.setState({ employeesEditPageFormInfoMessage: "" });
		this.setState({ employeesEditPageFormErrorMessage: "" });

		var self = this;
		var $form = $(e.target);

		function submitAction(result, msg) {
			var employeesEditPageFormMode = "update";
			if(!$("#employees-edit-page-form").find("#form-cancel-button").length) {
				switch(employeesEditPageFormMode) {
					case "insert": {
						$form[0].reset();
					}; break;
					...
					case "update": {
						...
						self.setState({ employeesEditPageFormInfoMessage: message });
					}; break;
				}
			}
		...
		function errorAction(msg) {
			...
			self.setState({ employeesEditPageFormErrorMessage: message });
		}
	...
	render() {
		return (
	<div id="employees-edit-page-form" className="">
		...
		<form role="form" onSubmit={this.onSubmit}>
			{this.state.employeesEditPageFormErrorMessage ? this.renderErrorMessage() : null}
					{this.state.employeesEditPageFormInfoMessage ? this.renderInfoMessage() : null}
